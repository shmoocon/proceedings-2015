...
and without any specialized hardware or manual interaction.  It is also
different because it is now well understood how to fully eliminate timing
leakage. This tutorial explains how to write *constant-time* software, i.e.,
software that does not leak any secret information through timing.
